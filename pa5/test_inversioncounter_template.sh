...
# Version : 
# Date    : 30 Oct 2022
# Description : Test cases for inversion counter programming assignment
...
run_test_with_args_and_input "slow" "1 1 1 1 1 1 1" "Enter sequence of integers, each followed by a space: Number of inversions: 0" # Repeated number
run_test_with_args_and_input "slow" "$(echo {1..100000})" "Enter sequence of integers, each followed by a space: Number of inversions: 0" # Max inputs
run_test_with_args_and_input "slow" "$(echo {100000..1})" "Enter sequence of integers, each followed by a space: Number of inversions: 4999950000" # Max inputs
